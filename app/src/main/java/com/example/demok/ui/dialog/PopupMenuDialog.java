...
import com.example.demok.utils.WifiConnectChangedReceiver;
...
public class PopupMenuDialog implements View.OnClickListener {
    TextView mTxtTitle;
    ...
    public PopupMenuDialog builder() {
        ...
        shared_wifi_cancel.setOnClickListener(this);
    ...
    @Subscribe(tags = {@Tag(ConstWifi.RxBusEventType.WIFI_CONNECT_CHANGE_EVENT)})
    ...
    void onWifiConnected(String ipAddr) {
        ...
        mTxtAddress.setText(String.format(context.getString(R.string.http_address), ipAddr, ConstWifi.HTTP_PORT));
        mButtonSplitLine.setVisibility(View.GONE);
        mBtnWifiSettings.setVisibility(View.GONE);
    }
    ...
    void onDialogDismiss(DialogInterface dialog) {
        ...
        RxBus.get().post(ConstWifi.RxBusEventType.POPUP_MENU_DIALOG_SHOW_DISMISS, ConstWifi.MSG_DIALOG_DISMISS);
